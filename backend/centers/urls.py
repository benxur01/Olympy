...
urlpatterns = [
    ...
    path('<int:center_id>/activity-trend/', views.center_activity_trend, name='center-activity-trend'),
    path('<int:center_id>/region-rank/', views.center_region_rank, name='center-region-rank'),
