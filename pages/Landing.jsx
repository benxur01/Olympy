...
const LandingPage = ({ onNavigate, user }) => {
  ...
  const FALLBACK_PRICING = [
    ...
    // Pro
    { id: 21, name: 'Pro', plan_type: 'organization', price: '799 999 UZS', duration_days: 30, desc: 'Yirik ta\'lim tashkilotlari uchun (1 oy)', features: ["Cheksiz o'quvchi qo'shish", "Plus reja imkoniyatlari", "Cheksiz olimpiada", "API kirish", "Maxsus qo'llab-quvvatlash", "Ota-onalar paneli"], popular: false },
    { id: 22, name: 'Pro', plan_type: 'organization', price: '2 159 999 UZS', duration_days: 90, desc: 'Yirik ta\'lim tashkilotlari uchun (3 oy)', features: ["Cheksiz o'quvchi qo'shish", "Plus reja imkoniyatlari", "Cheksiz olimpiada", "API kirish", "Maxsus qo'llab-quvvatlash", "Ota-onalar paneli"], popular: false },
    { id: 23, name: 'Pro', plan_type: 'organization', price: '3 839 999 UZS', duration_days: 180, desc: 'Yirik ta\'lim tashkilotlari uchun (6 oy)', features: ["Cheksiz o'quvchi qo'shish", "Plus reja imkoniyatlari", "Cheksiz olimpiada", "API kirish", "Maxsus qo'llab-quvvatlash", "Ota-onalar paneli"], popular: false },
    { id: 24, name: 'Pro', plan_type: 'organization', price: '6 719 999 UZS', duration_days: 365, desc: 'Yirik ta\'lim tashkilotlari uchun (1 yil)', features: ["Cheksiz o'quvchi qo'shish", "Plus reja imkoniyatlari", "Cheksiz olimpiada", "API kirish", "Maxsus qo'llab-quvvatlash", "Ota-onalar paneli"], popular: false },
  ];
